...
void main() {
  ...
  late GetRecommendedProductsUseCase useCase;

  setUp(() {
    mockProductsRepository = MockProductsRepository();
    useCase = GetRecommendedProductsUseCase(mockProductsRepository);
  });

  group('test GetRecommendedProductsUseCase', () {
    final productList = [
